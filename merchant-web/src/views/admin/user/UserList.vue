<template>
  <div class="page-shell">
    ...
    <el-card shadow="never">
      ...
      <div class="toolbar">
        <div class="filters">
          <el-input class="filter-wide" v-model="filters.keyword" placeholder="昵称 / 手机号" clearable @keyup.enter="loadData" />
          <el-select v-model="filters.status" placeholder="状态" clearable>
            <el-option label="正常" :value="1" />
            <el-option label="禁用" :value="0" />
          </el-select>
        </div>
        <el-button class="toolbar-action" type="primary" @click="loadData">查询</el-button>
      </div>
    </el-card>
